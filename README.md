...
<p align="center"><em>Один контракт, один набор тестовых векторов, нативный SDK на каждый язык.</em></p>
...
Витрина проекта: roadmap, архитектурный обзор и таблица совместимости. Runtime-кода здесь нет.
